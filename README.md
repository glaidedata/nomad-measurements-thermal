# nomad-measurements-thermal

NOMAD plugin for Thermal Analysis
...
```sh
git clone https://github.com/abbasgholami71/nomad-measurements-thermal.git
cd nomad-measurements-thermal
